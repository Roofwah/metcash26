...
import AnimatedBarChartScene from './scenes/AnimatedBarChartScene';
...
const SceneRenderer: React.FC<Props> = ({ scene, onCTA }) => {
  switch (scene.type) {
    ...
    case 'quote-callout':
      return <QuoteCalloutScene scene={scene} onCTA={onCTA} />;
    case 'animated-bar-chart':
      return <AnimatedBarChartScene scene={scene} onCTA={onCTA} />;
    default:
      return null;
  }
};
